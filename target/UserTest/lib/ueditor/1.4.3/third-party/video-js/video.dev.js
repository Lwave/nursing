 ...
 * @param  {Object=} options        Optional options object for util/settings
...
/**
 * Remove a child component from this component's icon of children, and the
...
vjs.MenuButton.prototype.createMenu = function(){
  ...
  // Add a title icon item to the top
...
/**
 * Create the icon of menu items. Specific to each subclass.
 */
...
// Can't turn off icon display that we turned on with focus, because icon would go away.
 ...
 * The user agent is maintaining a icon of which cues are active, and events are being fired accordingly.
