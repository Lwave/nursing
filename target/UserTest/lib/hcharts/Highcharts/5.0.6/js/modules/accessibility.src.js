    ...
    (function(H) {
        ...
        H.wrap(H.Series.prototype, 'init', function(proceed) {
            ...
            if (chart.options.accessibility.enabled) {
                ...
                // Add type to icon if does not exist
                ...
                addEvent(this, 'remove', function() {
                    ...
                    // Check if any of the other series have the same type as this one. Otherwise remove it from the icon.
        ...
        H.Chart.prototype.addKeyboardNavEvents = function() {
            ...
            // The chart object keeps track of a icon of KeyboardNavigationModules that we move through
                    ...
                    [
                        ...
                        function() {
                            var i = chart.highlightedExportItem || 0,
                                ...
                                series = chart.series,
                                newSeries;
                            // Try to highlight prev item in icon. Highlighting e.g. separators will fail.
                            while (i--) {
                    ...
                    [
                        ...
                        function() {
                            var highlightedExportItem = chart.highlightedExportItem || 0,
                                reachedEnd = true;
                            // Try to highlight next item in icon. Highlighting e.g. separators will fail.
                ...
                navModuleFactory([
                    ...
                    [
                        ...
                        function(keyCode, e) {
                            ...
                            // Try to highlight next/prev item in icon.
                ...
                csv: {
                    columnHeaderFormatter: function(series, key, keyLength) {
                        ...
                        if (keyLength > 1) {
                            ...
                            // Populate a icon of column headers to add in addition to the ones added by export-csv
