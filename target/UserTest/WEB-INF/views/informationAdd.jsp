...
<div class="page-container">
    <form class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text"  class="input-text" value="" placeholder="2020-02-19 04:03:15" name="createTime" id="createTime" />
            </div>
        </div>
    ...
    $("#form-admin-add").validate({
        ...
        submitHandler: function (form) {
            $(form).ajaxSubmit({
                async: false,
                type: 'post',
                url: "/inforShow?icon=" + icon + "&title=" + title.value + "&createTime=" + createTime.value + "&content=" + content.value,
                ...
                error: function (XmlHttpRequest, textStatus, errorThrown) {
                    layer.msg('error777!', {icon: 1, time: 1000});
                }
            });
