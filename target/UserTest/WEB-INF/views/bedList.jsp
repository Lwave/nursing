...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="datadel()"
                                                               class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>  <a class="btn btn-primary radius" onclick="product_add('添加信息','/insertBed')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加信息</a></span><span class="r">共有数据：<strong
            style="color: #5bc0de;">${bed.size()}</strong> 条</span>
    </div>
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <c:forEach items="${bed}" var="bed">
                <tr class="text-c">
                    ...
                    <td class="text-l" style="vertical-align:middle;"><img style="height: 100px;width: 100px;margin-left:48px;  "
                                                                           src="${bed.icon}"></td>
                    <td>${bed.user.username}</td>
                   ...
                   <%-- <td>${bed.dormitory.bedcount}</td>--%>
                    ...
                    <td class="td-manage">
                        <a
                            ...
                            onClick="product_edit('状态编辑','${pageContext.request.contextPath}/editBed',${bed.id},'750','600')"
                            href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
                        <a
                            style="text-decoration:none" class="ml-5" onClick="product_del(this,${bed.id})"
