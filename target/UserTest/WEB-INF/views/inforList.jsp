...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="datadel()"
            ...
            class="btn btn-primary radius" onclick="product_add('添加信息','/informationAdd')" href="javascript:;"><i
            class="Hui-iconfont">&#xe600;</i> 添加信息</a></span><span class="r">共有数据：<strong
            style="color: #5bc0de;">${inforr.size()}</strong> 条</span>
    </div>
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tbody>
            <c:forEach items="${inforr}" var="in" varStatus="aa">
                <tr class="text-c">
                    <td><input name="delete" type="checkbox" value="${in.id}"></td>
                    <td>${aa.count}</td>
                    <td class="text-l">
                        <c:if test="${in.pic != ''}">
                            <img style="height: 100px;width: 100px;margin-left:103px" src="${in.pic}">
                        </c:if>
                        <c:if test="${in.pic == ''}">
                             <span style="margin-left:148px">无</span>
                        </c:if>

                    </td>
                    <td>${in.title}</td>
                    <td>${in.createtimeStr}</td>
                    <td>
                    ...
                    <td class="td-manage">
                        <a
                                ...
                                onClick="product_edit('状态编辑','${pageContext.request.contextPath}/editInformation',${in.id},'750','600')"
                                href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
                        <a
                                style="text-decoration:none" class="ml-5" onClick="product_del(this,${in.id})"
...
<script type="text/javascript">
    ...
    function product_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.ajax({
                type: 'POST',
                url: '${pageContext.request.contextPath}/delinfor?id=' + id,
                dataType: 'json',
