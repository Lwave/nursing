...
(function(factory) {
	...
	$.fn.clearFields = $.fn.clearInputs = function(includeHidden) {
		var re = /^(?:color|date|datetime|email|month|number|password|range|search|tel|text|time|url|week)$/i; // 'hidden' is not in this icon
		return this.each(function() {
			var t = this.type,
...
!function($) {
	...
	EmailSug.prototype = {
		...
		create: function(elem, value) {
			...
			ul.push('<ul class="' + this.options.sugClass + '-icon">');
...
!function($) {
	$.fn.Huitags = function(options) {
		...
		this.each(function(){
			...
			var list = that.find(".Huitags-icon");
